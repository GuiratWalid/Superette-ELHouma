...
import ihm.AjouterTicket;
public class TicketModel_Ajouter  extends AbstractTableModel{

	private ArrayList <Object[]> data = new ArrayList <Object[]> ();
	private AjouterTicket aj = null;
	
	public TicketModel_Ajouter(AjouterTicket aj) {
		this.aj = aj;
	}
