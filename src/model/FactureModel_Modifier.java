...
import ihm.ModifierFacture;
import oo.Categorie;
import oo.Produit;

public class FactureModel_Modifier extends AbstractTableModel{

	private ResultSetMetaData rsmd;
	private ArrayList <Object[]> data = new ArrayList <Object[]> ();
	private ModifierFacture md = null;
	
	public FactureModel_Modifier(ModifierFacture md) {
		this.md = md;
	}
	...
	public void setValueAt(Object val, int l, int c) {
		...
		md.textTotal.setText(Double.toString(getSomme()));
		this.fireTableDataChanged();
