...
public class SupprimerMagasin extends JFrame implements ActionListener,WindowListener,ItemListener{
	...
	public SupprimerMagasin() {
		...
		this.setTitle("Supprimer un Magasin");
		...
		// Titre
		labelName = new JLabel("Supprimer un Magasin");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btSupprimer) {
			...
			Magasin magasin = new Magasin(id, nom, adresse,tel);
			MagasinDAO fd = new MagasinDAO();
			Magasin f = fd.supprimer(magasin);	
			if (magasin != null) {
				JOptionPane.showMessageDialog(null, "Magasin est supprimé avec succès");				
		}
		else
				JOptionPane.showMessageDialog(null, "Problème de Supprimer du Magasin");
			fd.fermerConnexion();
