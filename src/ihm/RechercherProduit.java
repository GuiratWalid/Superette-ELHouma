...
public class RechercherProduit extends JFrame implements ActionListener,WindowListener {
	...
	public RechercherProduit() {
		...
		this.setTitle("Rechercher un produit");
		...
		// Titre
		labelName = new JLabel("Rechercher un produit");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btRechercher) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Problème de recherche du produit");
				e1.printStackTrace();
			}
			pd.fermerConnexion();
		}
