...
public class SupprimerEmploye extends JFrame implements ActionListener,WindowListener,ItemListener{
	...
	public SupprimerEmploye() {
		...
		this.setTitle("Supprimer un employé");
		...
		// Titre
		labelName = new JLabel("Supprimer un employé");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btSupprimer) {
			...
			double salaire = Double.parseDouble(textSalaire.getText());
			...
			String d1 = a1+"-"+m1+"-"+j1;
			String d2 = a2+"-"+m2+"-"+j2;
			Employe emp = new Employe(id, nom, prenom, tel, adresse,salaire ,d2 , d1);
			EmployeDAO cd = new EmployeDAO();
			Employe s = cd.supprimer(emp);
			if (s != null) {
				JOptionPane.showMessageDialog(null, "Employé est supprimé avec succès");	
			}
			else
				JOptionPane.showMessageDialog(null, "Problème de suppression de l'Employé");
