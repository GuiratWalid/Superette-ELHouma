...
public class AfficherToutFournisseur extends JFrame implements  WindowListener{

	private JLabel labelName;
	DefaultTableModel model = new DefaultTableModel();

	public AfficherToutFournisseur() {
		
		// Conception de la page
		this.setTitle("Liste des fournisseur");
		...
		// Titre
		labelName = new JLabel("Liste des fournisseur");
