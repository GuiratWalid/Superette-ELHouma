...
public class AfficherToutCategorie extends JFrame implements  WindowListener{

	private JLabel labelName;
	DefaultTableModel model = new DefaultTableModel();

	public AfficherToutCategorie() {
		
		// Conception de la page
		this.setTitle("Liste des catégories");
		...
		// Titre
		labelName = new JLabel("Liste des catégories");
