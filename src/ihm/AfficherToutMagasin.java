...
public class AfficherToutMagasin extends JFrame implements  WindowListener{

	private JLabel labelName;
	DefaultTableModel model = new DefaultTableModel();

	public AfficherToutMagasin() {
		
		// Conception de la page
		this.setTitle("Liste des Magasins");
		...
		// Titre
		labelName = new JLabel("Liste des Magasins");
