...
public class SupprimerClient extends JFrame implements ActionListener,ItemListener,WindowListener{
	...
	public SupprimerClient() {
		...
		// Titre
		labelName = new JLabel("Supprimer un client");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btSupprimer) {
			...
			Client s = cd.supprimer(c);
			if (s != null) {
				JOptionPane.showMessageDialog(null, "Client est supprimé avec succès");	
			}
			else
				JOptionPane.showMessageDialog(null, "Problème de suppression du Client");
