...
import model.FactureModel_AfficherTout;
import model.TicketModel_AfficherTout;

public class AfficherToutFacture extends JFrame{

	private JLabel labelName;
	FactureModel_AfficherTout model = new FactureModel_AfficherTout();

	public AfficherToutFacture() {
		...
		// Titre
		labelName = new JLabel("Liste des factures");
